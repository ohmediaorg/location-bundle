...
{
    "type": "vcs",
    "url": "https://github.com/ohmediaorg/location-bundle"
}
```

Then run `composer require ohmediaorg/location-bundle:dev-main`.

Import the routes in `config/routes.yaml`:

```yaml
oh_media_location:
    resource: '@OHMediaLocationBundle/config/routes.yaml'
```
